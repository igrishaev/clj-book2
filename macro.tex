...
#1%
\footnote{\raggedright\StrSubstitute{#2}{https://}{}\ifdmk\tiny{\,.}\fi}%
\marginpar{%
...
\ifebook
\NewDocumentCommand{\footurl}{ m m O{} O{} }{\href{#2}{\underline{#1}}}
\fi
...
\newcommand{\code}[1]{\begin{english}\ttfamily\hyphenchar\font=45\relax{#1}\end{english}}
