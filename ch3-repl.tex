...
Dev-секции встречаются во многих библиотеках, в том числе Clojure. Например, модуль clojure.zip \footurl{содержит блок}{\urlzipclj}[zip.clj] \code{comment} с набором шагов, где проверяется логика \footurl{зипперов}{\urlzippers}[Зипперы].
