...
Недостаток глобализации в том, что она не учитывает некоторые обстоятельства. Если в словаре указана переменная \code{a} и такая же переменная задана в пространстве, после очистки мы потеряем ее:
