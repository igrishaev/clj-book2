...
Обратите внимание на разницу в приглашении. Мы задали внутреннему REPL параметр \code{:prompt}, чтобы лучше понимать, в каком сеансе пребываем сейчас \coderef{3}. Для выхода из отладки нажмите \code{Ctrl/Command+D}. Это сочетание подаст на вход символ \code{EOF}, что расценивается как сигнал завершения. Управление выйдет из внутреннего REPL, и вы получите результат \code{format-user}:
