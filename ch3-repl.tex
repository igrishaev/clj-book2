...
\textbf{Третий} способ~--- выполнить архив jar. Старые версии Clojure (до 1.8 включительно) состоят из одного jar-файла, который запускается командой \code{java -jar}:
...
\def\urlcidermid{https://github.com/clojure-emacs/cider-nrepl/tree/master/src/cider/nrepl/middleware}
...
\def\urlemacsscratch{https://www.gnu.org/software/emacs/manual/html\_node/emacs/Lisp-Interaction.html}
