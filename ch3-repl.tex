...
Подготовим словарь запроса. Мы передаем параметр \code{type=twopart}, чтобы шутка состояла из двух частей (подробнее об этом~--- ниже):
