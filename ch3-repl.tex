...
\noindent
и выполнить поиск еще раз, в выборке окажется символ \code{user/up\-da\-ted-result}.
...
Если возникло исключение, REPL напечатает только его класс и сообщение, чтобы не тратить место на стек-трейс. Функция \code{pst} (сокращение от \textbf{p}rint \textbf{s}tack \textbf{t}race) принудительно выводит полное исключение.
