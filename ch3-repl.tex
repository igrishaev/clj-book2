...
С внедрением практик, что мы рассмотрели~--- тесты, окружение, централизованный сбор ошибок~--- стало возможным повторить любую ситуацию на машине разработчика. Это быстрее и безопасней, чем подключение к удаленной машине. В команде автора больше не подключались к боевому серверу, и хочется верить, что это до сих пор так.

Для своего времени удаленное подключение было революционным. Возможность узнать состояние программы, запущенной где-то далеко, казалась чудом. Это выгодно отличало Lisp от компилируемых языков, которые, без особых ухищрений, не позволяли внедряться в программы. Но по сегодняшним меркам у этого подхода важные недостатки: он ситуативен и не поддается автоматизации. Даже если вы нашли ошибку методом подключения, ее нужно зафиксировать тестом, чтобы в будущем кто-то другой не расследовал ее опять. Тесты и окружение хорошо поддаются автоматизации и поэтому их преимущество бесспорно.
