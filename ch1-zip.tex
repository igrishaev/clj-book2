...
\index{функции!clojure.zip/up}
\index{функции!clojure.zip/down}
\index{функции!clojure.zip/next}
\index{функции!clojure.core/get-in}
...
\index{функции!clojure.zip/vector-zip}
...
\index{функции!clojure.xml/parse}
\index{функции!clojure.zip/xml-zip}
...
\index{функции!clojure.core/mapcat}
...
\index{функции!clojure.core/xml-seq}
...
\index{функции!clojure.zip/right}
...
\index{функции!clojure.zip/edit}
\index{функции!clojure.zip/replace}
\index{функции!clojure.zip/root}
...
\noindent
и после. Обратите внимание ключ \code{:changed?} в последней строке:
...
\index{функции!clojure.zip/remove}
...
\index{функции!clojure.zip/insert-left}
\index{функции!clojure.zip/insert-right}
\index{функции!clojure.zip/insert-child}
\index{функции!clojure.zip/append-child}
...
\index{функции!clojure.zip/emit}
